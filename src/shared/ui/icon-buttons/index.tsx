...
interface DeleteButtonProps extends ButtonHTMLAttributes<any> {

}

export const DeleteButton: React.FC<DeleteButtonProps> = ({ ...rest }) => {
    return (
        <button {...rest} className={cn(cl.btn, rest.className || '')}>
...
export const CloseButton: React.FC<DeleteButtonProps> = ({ ...rest }) => {
    return (
        <button {...rest} className={cn(cl.btn, cl.view, rest.className || '')}>
...
export const ViewButton: React.FC<DeleteButtonProps> = ({ ...rest }) => {
    return (
        <button {...rest} className={cn(cl.btn, cl.view, rest.className || '')}>
